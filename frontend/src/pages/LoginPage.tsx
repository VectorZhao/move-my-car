  ...
  return (
    <div className="main-content">
      <div className="glass-card" style={{ width: '100%', maxWidth: 420 }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.7)' }}>登录你的挪车控制台，管理员可添加车主账号。</p>
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1.5rem' }}>
          <label>
            <span>账号</span>
            <input value={identifier} onChange={(e) => setIdentifier(e.target.value)} placeholder="admin" autoComplete="username" required type="text" />
          </label>
          <label>
            <span>密码</span>
